...
* https://kubernetes.io/blog/
  ...
  **Quick Kind Install Guide (Binary Method):**
* 1️⃣ curl -Lo ./kind https://kind.sigs.k8s.io/dl/v0.31.0/kind-linux-amd64
* 2️⃣ chmod +x ./kind 
* 3️⃣ sudo mv ./kind /usr/local/bin/kind 
* 4️⃣ kind create cluster --name  cluster-name
